...
const ManageAllBookings = () => {
  ...
  useEffect(() => {
    axios
      .get("https://calm-depths-48491.herokuapp.com/manageAllBookings")
      .then((result) => {
  ...
  const handleRemove = (id) => {
    ...
    if (proceed) {
      axios
        .delete(`https://calm-depths-48491.herokuapp.com/deleteBooking/${id}`)
        .then((result) => {
  ...
  const handleApprove = (id) => {
    ...
    if (proceed) {
      axios
        .put(`https://calm-depths-48491.herokuapp.com/approveBooking/${id}`)
        .then((result) => {
